...
const Services = ({ onOpenBookingModal }) => {
  return (
    <section id="services" className="py-12 md:py-18 bg-slate-50 text-slate-900 relative overflow-hidden border-b border-slate-200">
      ...
      {/* Background Glow */}
      <div className="absolute bottom-10 right-1/4 w-96 h-96 bg-emerald-100/50 rounded-full blur-[160px] pointer-events-none" />
            ...
            return (
              <SwiperSlide key={srv.id} className="h-auto">
                <div
                  ...
                  className="glass-card-light p-4 rounded-2xl border border-slate-200 hover:border-emerald-400 transition-all flex flex-col justify-between cursor-pointer group shadow-2xs h-full"
                >
                  <div>
                    <div className="flex items-center justify-between mb-2.5">
                      <div className="w-8 h-8 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-600 flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                    ...
                    <h3 className="text-xs md:text-sm font-black text-slate-900 font-heading group-hover:text-emerald-600 transition-colors leading-tight">
                      {srv.title}
                    </h3>
                  ...
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-between mt-2.5 text-[11px]">
                    ...
                    <div className="w-5 h-5 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-500 group-hover:text-emerald-600 group-hover:border-emerald-400">
